            ...
            <v-row class="fill-height" align="center" justify="center">
              <div class="d-flex flex-colum">
                <v-card-text>
                  ...
                  <p class="text-h6" align="center">{{ currentWeather }}</p>
                  <div align="center">
                    <img :src="icon" alt="" />
                  </div>
                  <p class="text-h1" align="center">{{ currentTemp }}</p>
                </v-card-text>
              </div>
            </v-row>
          </v-sheet>
...
export default {
  ...
  methods: {
    fetchCities() {
      this.cities = ["Barrie", "Toronto", "Tokyo", "Bloomington", "GuangZhou"];
    },
    ...
    weather: {
      query: gql`
        query getWeather($city: String!) {
          weather: getCityByName(name: $city) {
            name
            weather {
              summary {
                title
